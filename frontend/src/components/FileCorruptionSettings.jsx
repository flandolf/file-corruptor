...
function FileCorruptionSettings({ corruptionType, setCorruptionType, corruptionStrength, setCorruptionStrength }) {
    ...
    return (
        <div>
            ...
            <form>
                ...
                <Radio.Group id="radio-group" defaultValue="random" onChange={handleTypeChange} buttonStyle="solid">
